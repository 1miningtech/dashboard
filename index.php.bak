...
<div id="pool">
	<form action="" method="post" style="margin-left:60px">
		IP地址: <input style="color:blue" type="text" name="ip" size="10" value=<?php echo $ip ?> />
		子网掩码: <input style="color:blue" type="text" name="netmask" size="10" value=<?php echo $netmask ?> />
		网关IP: <input style="color:blue" type="text" name="gateway" size="10" value=<?php echo $gateway ?> />
...
<div id="pool">
	<form action="" method="post" style="margin-left:60px">
		矿池1地址: <input style="color:blue" type="text" name="pool1" size="33" value=<?php echo $pool1 ?> />
		矿池1帐号: <input style="color:blue" type="text" name="id1" size="10" value=<?php echo $id1 ?> />
		矿池1密码: <input style="color:blue" type="text" name="pwd1" size="10" value=<?php echo $pwd1 ?> /> <br \>
		矿池2地址: <input style="color:blue" type="text" name="pool2" size="33" value=<?php echo $pool2 ?> />
		矿池2帐号: <input style="color:blue" type="text" name="id2" size="10" value=<?php echo $id2 ?> />
		矿池2密码: <input style="color:blue" type="text" name="pwd2" size="10" value=<?php echo $pwd2 ?> /> <br \>
		矿池3地址: <input style="color:blue" type="text" name="pool3" size="33" value=<?php echo $pool3 ?> />
		矿池3帐号: <input style="color:blue" type="text" name="id3" size="10" value=<?php echo $id3 ?> />
		矿池3密码: <input style="color:blue" type="text" name="pwd3" size="10" value=<?php echo $pwd3 ?> /> <br \>
		</br>
		难度选择 : <select name="difficulty">
			   ...
			   <?php echo "--当前难度:"?><?php echo cg_diff()?>&nbsp;&nbsp;&nbsp;		
		启动方式: <select name="starttype">
                                <option value="0" <?php echo $cg_option_starttype_webstart ?>  >网页手动启动</option>
                                <option value="1" <?php echo $cg_option_starttype_autostart ?> >上电自动启动</option>
                          </select>
		启动:	  <input type="radio" name="control" value="start" <?php echo $cg_radio_start?> />
		关闭:	  <input type="radio" name="control" value="stop"  <?php echo $cg_radio_stop?> />
...
<div id="status">
	...
	<form action="./miner.php" target="_blank" method="post" style="margin-left:60px">
		矿机运行状态:<font color=<?php echo $cg_status_color?>> <?php echo $cg_status_info?> </font> <input type="submit" value="矿机实时监控" />
	</form>
...
<div id="log">
	...
	<form action="" method="post" style="margin-left:0px">
		矿机运行日志:<input type="submit" value="刷新日志" />
	</form>
	<?php echo $cg_log?>
</div>
